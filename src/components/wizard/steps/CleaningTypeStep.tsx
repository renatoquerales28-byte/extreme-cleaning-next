            ...
            <div className="max-w-5xl mx-auto w-full px-6 space-y-8">
                ...
                <div className="bg-[#F9F8F2] border border-[#024653]/10 rounded-2xl p-6 lg:p-10">
                        ...
                        {currentTypes.map((type) => {
                            ...
                            return (
                                ...
                                >
                                    {/* TAG */}
                                    <div className={`
                                        absolute top-4 left-4 px-2 py-0.5 rounded text-[7px] font-bold uppercase tracking-widest
                                        ${isSelected ? 'bg-white/10 text-[#05D16E]' : 'bg-[#024653]/5 text-[#024653]/30'}
                                    `}>
                                        {type.tag}
                                    </div>

                                    <div className={`w-16 h-16 flex items-center justify-center transition-all duration-500 mb-2 ${isSelected ? 'text-[#05D16E]' : 'text-[#024653]'}`}>
                                        <Icon size={42} strokeWidth={1.5} />
                                    </div>
                                    <div className="text-center">
                                        <p className="text-xs font-bold uppercase tracking-[0.2em] leading-none mb-2">{type.label}</p>
                                        <p className={`text-[9px] font-semibold uppercase tracking-widest opacity-40 leading-none ${isSelected ? "text-[#05D16E]" : ""}`}>
                                            {type.desc}
                                        </p>
                                    </div>
                    ...
                    <div className="mt-10 pt-8 border-t border-[#024653]/5">
                        <p className="text-[9px] font-semibold uppercase tracking-[0.3em] text-[#024653]/20 text-center">
