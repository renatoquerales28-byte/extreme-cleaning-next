        ...
        <div className="flex flex-col h-full justify-start md:justify-center w-full max-w-lg mx-auto py-4 antialiased">
            ...
            <div className="text-center space-y-2 shrink-0 mb-6">
                <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-ecs-brand-dark leading-[0.85] py-1">
                    Your <span className="text-ecs-accent">Estimate</span>
                </h2>
            ...
            <div className="lg:hidden bg-ecs-brand-dark shadow-sm rounded-2xl p-6 mb-8 flex items-baseline justify-between text-white">
                <div>
                ...
                <div className="text-right">
                    ...
                    <p className="font-black text-ecs-brand-light text-sm capitalize">{selectedFreq?.label}</p>
                </div>
            </div>

            <div className="space-y-4 w-full shrink-0 mb-4">
                {customerName ? (
                    <div className="bg-ecs-secondary border border-emerald-100 rounded-2xl p-6 mb-6">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-12 h-12 bg-ecs-accent/20 text-ecs-accent rounded-full flex items-center justify-center">
                                <User size={24} strokeWidth={2.5} />
                            </div>
                            <div>
                                <p className="text-xs font-bold text-ecs-accent uppercase tracking-wider">Welcome Back</p>
                                <h3 className="text-xl font-black text-ecs-brand-dark">{customerName}</h3>
                            </div>
                        </div>
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input {...register("firstName")} autoFocus={true} className={`w-full pl-12 pr-4 py-3.5 bg-white border-2 rounded-2xl outline-none transition-all font-bold text-sm ${errors.firstName ? 'border-rose-400' : 'border-slate-100 focus:border-ecs-brand-light'}`} placeholder="John" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-600 ml-1">Last Name</label>
                                <input {...register("lastName")} className={`w-full px-4 py-3.5 bg-white border-2 rounded-2xl outline-none transition-all font-bold text-sm ${errors.lastName ? 'border-rose-400' : 'border-slate-100 focus:border-ecs-brand-light'}`} placeholder="Doe" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <input {...register("email")} type="email" placeholder="john@example.com" className={`w-full pl-12 pr-4 py-3.5 bg-white border-2 rounded-2xl outline-none transition-all font-bold text-sm ${errors.email ? 'border-rose-400' : 'border-slate-100 focus:border-ecs-brand-light'}`} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <input {...register("phone")} type="tel" placeholder="(509) 555-0123" className={`w-full pl-12 pr-4 py-3.5 bg-white border-2 rounded-2xl outline-none transition-all font-bold text-sm ${errors.phone ? 'border-rose-400' : 'border-slate-100 focus:border-ecs-brand-light'}`} />
                            </div>
                        </div>
                    </>
                )}
                ...
                <div className="pt-2">
                    <button onClick={handleNext} disabled={isSubmitting} className="btn-accent w-full py-5 text-sm font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 shadow-md hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-70 disabled:cursor-wait">
