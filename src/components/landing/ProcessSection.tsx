...
export default function ProcessSection() {
    ...
    return (
        <section
            className="w-full bg-transparent h-auto lg:h-[100svh] lg:max-h-[1000px] flex flex-col justify-center pt-[15px] pb-[140px] lg:py-10 relative lg:-translate-y-[30px] snap-start scroll-mt-[130px]"
            id="process"
        >
            {/* =========================================
