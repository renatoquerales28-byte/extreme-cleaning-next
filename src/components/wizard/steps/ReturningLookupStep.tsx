            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto w-full px-6 items-stretch">
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-2 ml-1">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#024653]">1. Identity Authorization</span>
                    </div>
                    ...
                    <div className="flex-1 bg-[#F9F8F2] border border-[#024653]/10 rounded-xl p-6 lg:p-8 flex flex-col justify-center">
                        <div className="bg-white border-2 border-[#024653]/5 rounded-xl p-8 shadow-sm group hover:border-[#024653]/20 transition-all relative">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <span className="text-[10px] font-semibold uppercase tracking-widest text-[#024653]/30">Phone Connection</span>
                            </div>
                            ...
                            <input
                                ...
                                className="bg-transparent text-4xl font-bold text-[#024653] outline-none w-full tabular-nums tracking-widest placeholder:text-[#024653]/5"
                            />
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-2 ml-1">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#024653]">2. Vault Archive</span>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/50 border border-[#024653]/5 rounded-xl p-5 flex items-start gap-4">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#024653]">Secure Retrieval</p>
                        ...
                        <div className="pt-8">
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#024653]">New Customer?</p>
