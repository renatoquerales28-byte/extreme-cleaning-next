...
export default function ServiceSelectorSection() {
    ...
    return (
        <section className="w-full bg-transparent relative lg:h-[100svh] lg:max-h-[1000px] flex flex-col items-center justify-center snap-start scroll-mt-[130px] -translate-y-[30px]">
            <div className="max-w-[1700px] w-full h-full mx-auto px-6 lg:px-10 relative z-10 flex items-center justify-center py-0">
                ...
                <div className="w-full h-[85%] lg:h-[78%] grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 translate-y-[15px]">
