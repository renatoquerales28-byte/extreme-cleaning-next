    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center rounded-full aria-selected:!bg-[#024653] aria-selected:!text-white hover:aria-selected:!bg-[#024653] hover:aria-selected:!text-white focus:aria-selected:!bg-[#024653] focus:aria-selected:!text-white"
                ),
                day_range_end: "day-range-end",
                day_selected:
                    "bg-stone-900 text-stone-50 hover:bg-stone-900 hover:text-stone-50 focus:bg-stone-900 focus:text-stone-50 dark:bg-stone-50 dark:text-stone-900 dark:hover:bg-stone-50 dark:hover:text-stone-900 dark:focus:bg-stone-50 dark:focus:text-stone-900 !bg-[#024653] !text-white !rounded-full",
