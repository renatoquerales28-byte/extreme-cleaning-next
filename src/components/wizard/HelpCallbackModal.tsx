                    ...
                    >
                        ...
                        {status === "success" ? (
                            <div className="flex flex-col items-center justify-center text-center py-8 space-y-4">
                                ...
                                <h3 className="text-xl font-bold text-[#024653]">We&apos;re on it!</h3>
                            ...
                            <>
                                <div className="text-center mb-6">
                                    <h3 className="text-2xl font-bold text-[#024653] mb-2">Need a hand?</h3>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full h-12 rounded-xl bg-[#024653] hover:bg-[#02333d] text-white font-bold uppercase tracking-widest text-xs shadow-lg shadow-[#024653]/20 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                                    >
