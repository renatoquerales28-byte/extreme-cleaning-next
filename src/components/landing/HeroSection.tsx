...
export default function HeroSection() {
    ...
    return (
        <section id="hero-section" className="relative w-full bg-[#F9F8F2] pt-[60px] lg:pt-[20px] lg:h-[100svh] lg:max-h-[1000px] overflow-hidden font-sans text-[#024653] snap-start scroll-mt-[60px]">
