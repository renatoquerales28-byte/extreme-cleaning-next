        ...
        <div className="w-full flex-1 flex flex-col justify-center py-4">
            <div className="max-w-5xl mx-auto w-full px-6 space-y-4">
                ...
                <div className="flex items-center gap-3 ml-1">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#024653]">Select Service Division</span>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="text-center space-y-3">
                                    <h4 className="font-bold text-lg tracking-widest uppercase leading-none">{option.label}</h4>
                                    <div className="space-y-1">
                                        <p className={`text-[10px] font-semibold uppercase tracking-widest opacity-40 leading-relaxed ${isSelected ? "text-[#05D16E]" : "text-[#024653]"}`}>
                                            {option.desc}
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="flex justify-center pt-2">
                    <p className="text-[9px] font-semibold uppercase tracking-[0.3em] text-[#024653]/20">
