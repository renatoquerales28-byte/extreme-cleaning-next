...
export default function QuotePage() {
    return (
        <div className="min-h-[100dvh] w-full flex items-center justify-center p-4 md:p-8 overflow-y-auto relative selection:bg-accent selection:text-white bg-brand-dark">
            {/* Background Image */}
