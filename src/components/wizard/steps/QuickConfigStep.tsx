            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto w-full px-6 items-stretch">
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-2 ml-1">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#024653]">1. Cleaning Intensity</span>
                    </div>
                        ...
                        {CLEANING_TYPES.map((type) => {
                            ...
                            return (
                                <button
                                    ...
                                    `}
                                >
                                    <div className={`w-12 h-12 flex items-center justify-center transition-all ${isSelected ? 'text-[#05D16E]' : 'text-[#024653]'}`}>
                                        <Icon size={32} />
                                    </div>
                                    <div className="text-left">
                                        <p className="text-[11px] font-bold uppercase tracking-widest leading-none mb-1">{type.label}</p>
                                        <p className={`text-[8px] font-semibold uppercase tracking-widest opacity-40 ${isSelected ? "text-[#05D16E]" : ""}`}>
                                            {type.sub}
                                        </p>
                                    </div>
                                    {isSelected && (
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-2 ml-1">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#024653]">2. Service Cadence</span>
                    </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="text-center">
                                            <p className="text-[10px] font-bold uppercase tracking-widest leading-none">{freq.label}</p>
                                            {freq.discount && (
                                                <p className="text-[9px] font-bold text-[#05D16E] mt-1 tabular-nums italic">-{freq.discount}</p>
                                            )}
                                        </div>
                                        {isSelected && (
