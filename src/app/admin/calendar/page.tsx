...
export default function CalendarPage() {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 items-start">
            {/* Main Calendar Area */}
            <div className="flex-1 bg-white p-6 rounded-xl shadow-sm border border-[#D1D5DB] min-h-[600px]">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-xl font-serif text-[#1C1C1C] flex items-center gap-2">
                ...
                <div className="flex justify-center p-4">
                    <DayPicker
                        ...
                        classNames={{
                            day_selected: "bg-[#024653] text-white hover:bg-[#023641]",
            ...
            <div className="w-full lg:w-96 space-y-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-[#D1D5DB]">
                    <h3 className="font-bold text-xl text-[#1C1C1C] mb-1">
                                ...
                                <div className="space-y-3 p-4 bg-slate-50 rounded-xl">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="bg-white border border-red-200 text-red-600 px-4 py-2 rounded-lg text-xs font-bold uppercase hover:bg-red-50 transition-colors"
                                        >
                                            Block Date
                                        </button>
                                    </div>
                                ...
                                <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex gap-3 items-center">
                                            ...
                                            <div>
                                                <p className="font-bold text-red-800 text-sm">Date Blocked</p>
                                                <p className="text-red-600 text-xs">{selectedDayBlocked.reason}</p>
                                            </div>
                                        </div>
                                        <button
                                            onClick={() => handleUnblockDate(selectedDayBlocked.id)}
                                            className="text-xs font-bold text-red-500 hover:text-red-700 bg-white px-3 py-1.5 rounded-md shadow-sm"
                                        >
                                            Unblock
                                        </button>
                                    </div>
                                ...
                                {selectedDayBookings.length > 0 ? (
                                    <div className="space-y-3">
                                        {selectedDayBookings.map(booking => (
                                            <div key={booking.id} className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                                                <div className="flex justify-between items-start mb-3">
                                                    <div>
                                                        <span className="font-black text-[#024653] text-sm block">
                                                    ...
                                                    <span className="text-xs font-bold bg-[#0891B2]/10 text-[#0891B2] px-2 py-1 rounded-md">
                                                ...
                                                <div className="pt-3 border-t border-slate-50 flex items-center gap-2">
                                                    ...
                                                    <select
                                                        className="flex-1 text-xs border-none bg-slate-50 rounded-lg py-1.5 px-2 text-slate-600 outline-none cursor-pointer hover:bg-slate-100 transition-colors"
                                    ...
                                    <div className="text-center py-8 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                                        ...
                                        <p className="text-xs text-slate-300">Slots open: Check Settings</p>
                                    </div>
                                )}
                            </div>
                        </div>
