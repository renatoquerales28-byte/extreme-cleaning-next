                ...
                <div className="flex flex-col gap-3">
                    {activeContent.options.map((option) => (
                        ...
                        >
                            ...
                            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${selectedOption === option.id ? 'border-[#05D16E] bg-[#05D16E]' : 'border-gray-200'
                                }`}>
                                {selectedOption === option.id && <div className="w-2.5 h-2.5 bg-[#024653] rounded-full" />}
                            </div>
