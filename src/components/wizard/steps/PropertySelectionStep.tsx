            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto w-full px-6 items-stretch">
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-2 ml-1">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#024653]">1. Saved Blueprint Gallery</span>
                    </div>
                    ...
                    <div className="flex-1 bg-[#F9F8F2] border border-[#024653]/10 rounded-xl p-4 lg:p-6 space-y-3">
                        <AnimatePresence mode="popLayout">
                                ...
                                >
                                    <div className="flex items-center gap-4 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            <h3 className="text-sm font-bold text-[#024653] tracking-tight truncate">{prop.address}</h3>
                                            <div className="flex items-center gap-2 text-[#024653]/40 text-[9px] font-bold uppercase tracking-widest">
                            ...
                            >
                                ...
                                <div>
                                    <h4 className="text-[10px] font-bold uppercase tracking-widest leading-none mb-1">Add New Property</h4>
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center gap-2 ml-1">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#024653]">2. Vault Session</span>
                    </div>
                            ...
                            <div className="bg-white border-2 border-[#024653]/5 rounded-2xl p-8 shadow-2xl shadow-[#024653]/5 w-full relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#024653]/40">Authorized Client</p>
                                        <h2 className="text-2xl font-bold text-[#024653] tracking-tight">{customerName}</h2>
                                    </div>
                        ...
                        <div className="pt-8 w-full">
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#024653]">Not {customerName.split(' ')[0]}?</p>
