...
export default function HeroSection() {
    ...
    return (
        <section className="relative w-full bg-white pt-24 lg:pt-0 lg:h-[100dvh] lg:min-h-0 overflow-hidden font-sans text-[#024653]">
            <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 h-full gap-8 lg:gap-0">
                    ...
                    >
                            ...
                            <form onSubmit={handleStart} className="relative group">
                                <div className={`flex items-center bg-[#024653] rounded-full p-1.5 transition-all duration-300 ${isFocused ? 'scale-[1.02]' : ''}`}>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-transparent border-none focus:ring-0 text-white font-medium placeholder:text-white/40 text-lg px-4 py-2 h-12"
                                    />
                                    <button
                                        type="submit"
                                        disabled={zipCode.length < 5}
                                        className="bg-[#05D16E] hover:bg-[#04bd63] text-[#024653] w-12 h-12 rounded-full flex items-center justify-center transition-all disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                                    >
                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                            {["Residential Deep Clean", "Post-Construction", "Move-In Ready"].map((tag, i) => (
                                <span key={i} className="px-4 py-1.5 rounded-full bg-[#f3f6f6] text-[10px] font-medium tracking-wide text-[#024653]/80">
                                    {tag}
                                </span>
                            ))}
                        </div>
                        ...
                        {/* Promo Widget */}
                        <div className="flex items-center gap-4 pt-6 lg:pt-10 border-t border-gray-100 lg:border-none w-fit">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <div className="text-[11px] opacity-60 max-w-[200px]">Get 15% off your first deep cleaning service this month.</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
                ...
                <div className="relative h-[500px] lg:h-full w-full p-4 lg:p-10 lg:pl-0">
                    <motion.div
                        initial={{ opacity: 0, scale: 0.98 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 1, delay: 0.2 }}
                        className="relative w-full h-full rounded-[3rem] lg:rounded-[4.5rem] overflow-hidden"
                    >
                        <Image
                        ...
                        <div className="absolute top-8 left-8 text-white">
                            ...
                            <div className="text-[10px] uppercase tracking-widest opacity-80 mt-0.5">Cleans Completed</div>
                        </div>
            ...
            <div className="hidden lg:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30 pointer-events-none">
                <motion.div
                    ...
                    className="backdrop-blur-md bg-white/30 border border-white/40 p-3 rounded-full shadow-sm"
                >
                    <motion.div
                        animate={{ rotate: 360 }}
                    ...
                    >
                        <svg viewBox="0 0 200 200" className="w-full h-full">
                            ...
                            <text fill="#024653" fontSize="19" fontWeight="bold" letterSpacing="4">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <Sparkles size={20} className="text-[#024653]" />
                        </div>
                    </motion.div>
                </motion.div>
            </div>
