...
export default function Home() {
    ...
    return (
        <main className="min-h-screen bg-[#F9F8F2] selection:bg-accent selection:text-white light">
            ...
            <header
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 h-[60px] bg-white/20 backdrop-blur-[60px] backdrop-saturate-[180%] border-b border-white/60 ${scrolled
                    ? "shadow-[0_8px_32px_0_rgba(2,70,83,0.08)]"
                    : ""
                    }`}
            >
